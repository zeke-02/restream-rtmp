...
var handler = function (event, _context) { return __awaiter(void 0, void 0, void 0, function () {
    var UUID, rsequelize, rUser, result, User, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log(event);
                UUID = event.body.UUID ? event.body.UUID : JSON.parse(event.body).UUID;
                if (!UUID) {
                    return [2 /*return*/, {
                            statusCode: 400,
            ...
            case 2:
                ...
                return [4 /*yield*/, rUser.findByPk(UUID)];
            case 3:
                result = _a.sent();
                console.log(result);
                if (!result) {
